            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span >Apotik Dunia Lain </span>
                </a>
              </div><!-- End Logo -->

              <div class="card mb-3 shadow" style="background-color: #87CBB9;">

                <div class="card-body">

                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Login Pelayanan</h5>
                  ...
                  <form class="row g-3 needs-validation" action="" method="POST" novalidate>
                    ...
                    <?php if (isset($error)) { ?>
                        <p class="small mb-0" style="color: red;"><?php echo $error; ?></p>
                    <?php } ?>
                    <br>
                    <div class="col-12">
